...
rtl.addResource({name: "unit1", unit: "unit1", format: "application/octet-stream", encoding: "base64", data: ""});
...
rtl.module("Unit1",["System","browserconsole","BrowserApp","JS","Classes","SysUtils","Graphics","Controls","Forms","WebCtrls","Web","Mat4","MemoryBuffer","GLUtils","GLTypes","webgl","Math"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  rtl.createClass(this,"TWForm1",pas.Forms.TWForm,function () {
    ...
    this.FormCreate = function (Sender) {
      ...
      $impl.canvas2 = document.createElement("canvas");
      $impl.canvas2.width = 200;
      $impl.canvas2.height = 200;
      document.body.appendChild($impl.canvas2);
      $impl.gl = $impl.canvas2.getContext("webgl");
      if ($impl.gl === null) {
    ...
    this.WTimer1Timer = function (Sender) {
      $impl.gl.clearColor(0.3,0.0,0.0,1);
      $impl.gl.viewport(0,0,this.GetCanvas().FWidth,this.GetCanvas().FHeight);
      $impl.gl.clear(16384);
      $impl.projTransform = pas.Mat4.TMat4.$create("Ortho",[0,$impl.gl.canvas.width,$impl.gl.canvas.height,0,-1,1]);
      $impl.viewTransform = pas.Mat4.TMat4.$create("Identity");
      $impl.modelTransform = pas.Mat4.TMat4.$create("Identity");
  ...
  $mod.$implcode = function () {
    ...
    $impl.gl = null;
    $impl.shader = null;
    $impl.projTransform = null;
    $impl.viewTransform = null;
    $impl.modelTransform = null;
    $impl.rotateAngle = 0;
    $impl.UpdateCanvas = function (time) {
      ...
      $impl.nextTime = now;
      $impl.modelTransform = pas.Mat4.TMat4.$create("Identity");
      $impl.modelTransform = $impl.modelTransform.Multiply(pas.Mat4.TMat4.$create("Translate",[100,100,0]));
      $impl.modelTransform = $impl.modelTransform.Multiply(pas.Mat4.TMat4.$create("RotateZ",[pas.Math.DegToRad($impl.rotateAngle)]));
      $impl.rotateAngle = $impl.rotateAngle + (20 * $impl.deltaTime);
      $impl.shader.SetUniformMat4("modelTransform",$impl.modelTransform);
      $impl.gl.clear(16384);
