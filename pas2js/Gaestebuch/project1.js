...
rtl.addResource({name: "unit1", unit: "unit1", format: "application/octet-stream", encoding: "base64", data: ""});
...
rtl.module("Unit1",["System","browserconsole","JS","Classes","SysUtils","Graphics","Controls","Forms","WebCtrls"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TWForm1",pas.Forms.TWForm,function () {
    ...
    this.$final = function () {
      this.ButtonSend = undefined;
      this.WLabel1 = undefined;
      this.WMemo1 = undefined;
      pas.Forms.TWForm.$final.call(this);
    };
    this.ButtonSendClick = function (Sender) {
      this.WLabel1.SetText(this.WMemo1.FLines.GetTextStr());
    };
    rtl.addIntf(this,pas.System.IUnknown);
    var $r = this.$rtti;
    $r.addField("ButtonSend",pas.WebCtrls.$rtti["TWButton"]);
    $r.addField("WLabel1",pas.WebCtrls.$rtti["TWLabel"]);
    $r.addField("WMemo1",pas.WebCtrls.$rtti["TWMemo"]);
    $r.addMethod("ButtonSendClick",0,[["Sender",pas.System.$rtti["TObject"]]]);
  });
  this.WForm1 = null;
});
