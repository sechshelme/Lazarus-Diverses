...
rtl.module("utetris",["System","Classes","SysUtils","Web"],function () {
  ...
  rtl.createClass(this,"TTetris",pas.Classes.TComponent,function () {
    ...
    this.DoMouseClick = function (aEvent) {
      ...
      var S = "";
      Result = true;
      S = pas.Web.TJSEventHelper.GetCurrentTargetElement.call(aEvent).id;
    ...
    this.HittingTheWall = function () {
      ...
      while ((I < 4) && !Result) {
        ...
        Result = ((NewX <= 0) && (this.Fdirection === 2)) || ((NewX >= 11) && (this.Fdirection === 3));
        I += 1;
      };
      return Result;
    };
    ...
    this.RotateBlock = function () {
      ...
      if ((this.CheckForVerticalCollision(0,$mod.TBlock$clone(newBlock)) === 0) && !this.CheckForHorizontalCollision(0,$mod.TBlock$clone(newBlock))) {
        this.DeleteBlock();
