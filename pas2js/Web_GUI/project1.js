...
rtl.addResource({name: "unit1", unit: "unit1", format: "application/octet-stream", encoding: "base64", data: ""});
...
rtl.module("Unit1",["System","JS","Classes","SysUtils","Graphics","Controls","Forms","WebCtrls","StdCtrls"],function () {
  ...
  rtl.createClass(this,"TWForm1",pas.Forms.TWForm,function () {
    ...
    this.FormCreate = function (Sender) {
      this.GetCanvas().TextOut(100,100,"Hello World");
      this.SetText("Meine Webseite");
      this.RadioButton = pas.WebCtrls.TWRadioButton.$create("Create$1",[this]);
      this.RadioButton.SetParent(this);
      this.RadioButton.SetText("RadioButton");
      this.RadioButton.SetWidth(100);
      this.RadioButton.SetHeight(100);
      this.panel = pas.WebCtrls.TWPanel.$create("Create$1",[this]);
      this.panel.SetParent(this);
      this.panel.SetLeft(200);
      this.panel.SetTop(200);
    };
    this.FormResize = function (Sender) {
      this.GetCanvas().TextOut(this.GetClientWidth() - 200,100,"Hello World");
    };
